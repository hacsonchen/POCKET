...
using Pocket.Clients.Gordon.Cost4.Customization;
...
namespace Pocket.Clients.Gordon.Cost4
{
    public partial class MainForm : Form
    {
        ...
        private DummyHistoryExplorer m_solutionExplorer = new DummyHistoryExplorer();
        ...
        public MainForm()
        {
            ...
            m_solutionExplorer = new DummyHistoryExplorer();
        ...
        private DummyDoc CreateNewDocument()
        {
            ...
            dummyDoc.Text = text;
            dummyDoc.Icon = global::Pocket.Clients.Gordon.Cost4.Properties.Resources.clock_yellow;
            return dummyDoc;
        }
        ...
        {
            if (persistString == typeof(DummyHistoryExplorer).ToString())
        ...
        private void SetDockPanelSkinOptions(bool isChecked)
        {
            ...
            //    autoHideSkin.TextFont = new Font("宋体", 10);
            ...
            //    dockPaneSkin.TextFont = new Font("宋体", 10);
        ...
        private void toolBar_ButtonClick(object sender, System.Windows.Forms.ToolStripItemClickedEventArgs e)
        {
            if (e.ClickedItem == toolBarButtonNew)
                ...
                SetDockPanelSkinOptions(!toolBarButtonDockPanelSkinDemo.Checked); //重置
        ...
        private void menuItemLayoutByCode_Click(object sender, System.EventArgs e)
        {
            ...
            //DummyDoc doc5 = CreateNewDocument("Document5");
            doc1.Show(dockPanel, DockState.Document);
            doc2.Show(doc1.Pane, null); //即：和doc1相同的载体
            //doc5.Show(doc1.Pane, null); //即：和doc1相同的载体
